...
namespace Firehose.Web
{
    public class Suthahar : IAmACommunityMember, IFilterMyBlogPosts
    {
        ...
        public string ShortBioOrTagLine => "Suthahar insatiable desire to keep learning keeps the dynamic blogger. I take keen interest in sharing my knowledge and solving my readers’ technology-related problems.";
