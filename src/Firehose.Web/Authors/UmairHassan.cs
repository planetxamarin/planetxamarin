...
namespace Firehose.Web.Authors
{
	public class UmairHassan : IAmACommunityMember
	{
		...
		public string ShortBioOrTagLine => "Love to write & code";

		public Uri WebSite => new Uri("https://xamarinweb.com/");

		public string TwitterHandle => "umairhassan03";

		public string GitHubHandle => "umairhassan003";
		...
		public IEnumerable<Uri> FeedUris
		{
			get
			{
				yield return new Uri("https://xamarinweb.com/feed/");
			}
		}

		public GeoPosition Position => new GeoPosition(31.5197906, 74.2998918);
