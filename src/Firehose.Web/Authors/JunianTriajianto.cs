...
namespace Firehose.Web.Authors
{
	public class JunianTriajianto : IAmACommunityMember, IFilterMyBlogPosts
	{
		...
		public string ShortBioOrTagLine => "is a Software Engineer who enjoys problem solving with C# and any technology related to it like Xamarin, ASP.NET Core, and Unity 3D.";
